...
- Does NOT override [[cluster authoring conventions]] §3 — institutional template + companion-`.md` workflow conventions still apply once content reaches the canonical `.docx` stage.
