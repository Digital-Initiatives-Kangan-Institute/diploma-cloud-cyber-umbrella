...
Recorded 2026-05-31 after Tim flagged deprecated-process commentary in `delivery_process.md` as token burn. See [[draft-naming-pragmatism]] (same spirit: don't over-invest in things that don't serve the working artefact).
