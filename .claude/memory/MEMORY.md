...
- [S1-CL3 assessment](s1cl3_assessment.md) — Cloud Infrastructure Improvement (504 + 401, lightest): **instruments authored + validated 72/72** (AT1 Design / AT2 Team Implementation / AT3 Implement). Write-is-the-seam model (504 individual design+deploy; 401 the divided YAML write in AT2); encryption is baseline + data out of scope. Remaining: the AT3 lab-pack (engineering + live proving) + mappings.
