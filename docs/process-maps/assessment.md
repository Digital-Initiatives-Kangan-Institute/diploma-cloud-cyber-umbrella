...
**12 steps · 12 gates** — 10 machine-gated, 2 human-only, **0 flagged** for review.
...
flowchart TD
  ...
  G9_10{{"Gate 9→10<br/>human review"}}:::human
...
| 9→10 | human | human | — | — | human-only gate — candidate for tooling |
